...
function ProductCard() {
  return (
    <div className="w-full max-w-[425px] md:max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        {/* DESKTOP */}
    <Link className='hidden md:flex' href="#">
        <img className="p-8 rounded-t-lg" src="https://source.unsplash.com/500x500/?product" alt="product image" />
    </Link>
    {/* MOBILE */}
    <Link className='md:hidden' href="#">
        <img className="p-4 rounded-t-lg" src="https://source.unsplash.com/400x400/?product" alt="product image" />
    </Link>
