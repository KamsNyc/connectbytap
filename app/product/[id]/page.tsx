            ...
            <div>
              ...
              {rotate && (
                <p className="text-sm text-gray-500 mt-2">
                  This is a brief description of the dimensions or additional
                  information you want to display when the dimensions are
                  expanded.
                </p>
              )}
            </div>
...
<div className="flex flex-row justify-between items-center mt-4">
    <label htmlFor="reviewUrl" className="font-medium text-base leading-4 text-gray-600">
        Review URL
    </label>
    <input
        type="text"
        ...
        className="border border-gray-300 h-full text-base w-64 px-2"
    />
</div>
